...
static struct fimc_is_sensor_cfg config_2t2[] = {
	...
	/* 3360x3368@30fps */
	FIMC_IS_SENSOR_CFG(3360, 3368, 30, 22, 4),
	/* 3360x3368@24fps */
	FIMC_IS_SENSOR_CFG(3360, 3368, 24, 18, 5),
	/* 2984x1680@60fps */
	FIMC_IS_SENSOR_CFG(2984, 1680, 60, 22, 6),
	/* 2984x1680@30fps */
	FIMC_IS_SENSOR_CFG(2984, 1680, 30, 12, 7),
	/* 1480x832@120fps */
	FIMC_IS_SENSOR_CFG(1480, 832, 120, 12, 8),
	/* 1480x832@240fps */
	FIMC_IS_SENSOR_CFG(1480, 832, 240, 24, 9),
	/* 924x556@300fps */
	FIMC_IS_SENSOR_CFG(924, 556, 300, 12, 10),
};
