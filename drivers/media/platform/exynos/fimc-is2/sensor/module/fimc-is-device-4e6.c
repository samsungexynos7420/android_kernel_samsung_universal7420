...
static struct fimc_is_sensor_cfg config_4e6[] = {
	...
	/* 1304X980@30fps */
	FIMC_IS_SENSOR_CFG(1304, 980, 30, 22, 1),
	/* 1304X980@15fps */
	FIMC_IS_SENSOR_CFG(1304, 980, 15, 7, 2),
	/* 1304X980@10fps */
	FIMC_IS_SENSOR_CFG(1304, 980, 10, 7, 2),
	/* 1304X980@8fps */
	FIMC_IS_SENSOR_CFG(1304, 980, 8, 7, 2),
	/* 1304X980@7fps */
	FIMC_IS_SENSOR_CFG(1304, 980, 7, 7, 3),
};
